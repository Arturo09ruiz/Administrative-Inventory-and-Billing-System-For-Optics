...
class Modeloterminados{

	/*=============================================
	MOSTRAR PEDIDOS
	=============================================*/

	static public function mdlMostrarterminados($tabla, $item, $valor, $orden){
	...
	REGISTRO DE PEDIDO
	=============================================*/
	static public function mdlIngresarterminados($tabla, $datos){

		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(tipo_cristal, aumento_cristal, codigo, descripcion, lugar,precio_venta) VALUES (:tipo_cristal, :aumento_cristal, :codigo, :descripcion,  :lugar, :precio_venta)");
