      	...
      	success:function(respuesta){
	          ...
	          '<div class="col-xs-3 ingresoPrecio" style="padding-left:0px">'+
	            ...
	            '<div class="input-group">'+
	              ...
	              '<input type="hidden" class=" nuevoPrecioProductoBolivar" id="nuevoPrecioProductoBolivar" precioBolivarProducto="" name="nuevoPrecioProductoBolivar"  >'+
...
function listarProductos(){
	...
	var preciobolivar = $(".nuevoPrecioProductoBolivar");
	...
	for(var i = 0; i < descripcion.length; i++){
		...
		listaProductos.push({ "id" : $(descripcion[i]).attr("idProducto"), 
							  ...
							  "total" : $(precio[i]).val(),
							  "totalbolivar" : $(preciobolivar[i]).val()
							})
