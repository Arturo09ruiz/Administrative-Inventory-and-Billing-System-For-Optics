...
class ControladorVentas{
	...
	static public function ctrCrearVenta(){
		...
		if(isset($_POST["nuevaVenta"])){
			...
			$listaCristales = json_decode($_POST["listaCristales"], true);

			$totalCristalesComprados = array();

			foreach ($listaCristales as $key => $value) {

			   array_push($totalCristalesComprados, $value["cantidad"]);
				
			   $tablaCristales = "cristales";

			    $item = "id";
			    $valor = $value["id"];
			    $orden = "id";

			    $traerCristal = ModeloCristales::mdlMostrarCristales($tablaCristales, $item, $valor, $orden);

				$item1a = "ventas";
				$valor1a = $value["cantidad"] + $traerCristal["ventas"];

			    $nuevasVentas = ModeloCristales::mdlActualizarCristal($tablaCristales, $item1a, $valor1a, $valor);

				$item1b = "stock";
				$valor1b = $value["stock"];

				$nuevoStock = ModeloCristales::mdlActualizarCristal($tablaCristales, $item1b, $valor1b, $valor);
			...
			$valor1a = array_sum($totalCristalesComprados + $totalProductosComprados) + $traerCliente["compras"];
			...
			$datos = array("id_vendedor"=>$_POST["idVendedor"],
						   ...
						   "cristales"=>$_POST["listaCristales"],
						   "impuesto"=>$_POST["impuesto"],
						   "falta"=>$_POST["falta_por_dol"],
						   "totaldolar"=>$_POST["resultado"],
						   "total"=>$_POST["resultadobo"],
	...
	public function ctrDescargarReporte(){
		...
		if(isset($_GET["reporte"])){
			...
			echo utf8_decode("<table border='0'> 
					...
					<td style='font-weight:bold; border:1px solid #eee;'>MONTURAS</td>
					<td style='font-weight:bold; border:1px solid #eee;'>CANTIDAD</td>
					<td style='font-weight:bold; border:1px solid #eee;'>CRISTALES</td>
					<td style='font-weight:bold; border:1px solid #eee;'>CANTIDAD</td>
			 ...
			 echo utf8_decode("<tr>
				...
				echo utf8_decode("</td><td style='border:1px solid #eee;'>");	
			 	...
			 	foreach ($productos as $key => $valueProductos) {
						...
						echo utf8_decode("<p>Sin Monturas</p>");
						echo utf8_decode("</td><td style='border:1px solid #eee;'>0</td>");	
				...
				// 	echo utf8_decode("<td style='border:1px solid #eee;'>Sin Monturas</td>");	
				...
				$cristales =  json_decode($item["cristales"], true);

				if($cristales){	
				 foreach ($cristales as $key => $valueCristales) {
				echo utf8_decode("</td><td style='border:1px solid #eee;'>");	
			 			
					echo utf8_decode($valueCristales["descripcion"]."<br>");
					echo utf8_decode("</td>");	
				...
				echo utf8_decode("</td><td style='border:1px solid #eee;'>");	
			 	...
			 	foreach ($cristales as $key => $valueCristales) {
			 			...
			 			echo utf8_decode($valueCristales["cantidad"]."<br>");
			 		}

				}else{
						echo utf8_decode("</td><td style='border:1px solid #eee;'>");	
						echo utf8_decode("<p>Sin Cristales</p>");
						echo utf8_decode("</td>");	
